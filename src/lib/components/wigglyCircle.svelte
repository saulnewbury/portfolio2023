  ...
  onMount(() => {
    ...
    mm.add('(min-width: 769px)', () => {
      gsap.fromTo(
        container,
        { scale: 0 },
        { scale: 1, delay, duration: 1, ease: 'power1.out' }
      )
    })
    ...
    tl.fromTo(
      text,
      { rotate: -360 },
      { rotate: -25, delay, duration: 1.5, ease: 'elastic.out(1,1)' }
    )
